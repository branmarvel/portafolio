        ...
        <section id="home" className="relative w-full h-full flex flex-col justify-center items-center overflow-hidden">
            ...
            >
                ...
                <h1 className="text-6xl md:text-8xl font-bold tracking-tighter mb-6 text-gradient font-mono">
                    <span className="sr-only">Brandon Bello</span>
                    <span aria-hidden="true">
                        <ScrambleText text={t('hero.name')} />
                    </span>
                    <span className="inline-block w-[3px] h-[0.85em] bg-[var(--color-tungsten)] ml-1 align-middle" style={{ animation: 'blink 1.06s step-end infinite' }} />
                </h1>
                <motion.h2
