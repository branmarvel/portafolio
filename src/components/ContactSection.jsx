            ...
            >
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 lg:gap-24 shrink-0 pb-4">
                    ...
                    <motion.div variants={fadeInUp} className="flex flex-col gap-3 md:gap-6 justify-center glass-panel md:bg-transparent p-4 md:p-0 rounded-2xl md:rounded-none border border-[var(--color-border)] md:border-none">
                        ...
                        <a href="https://github.com/branmarvel" target="_blank" rel="noreferrer" className="flex items-center gap-3 md:gap-6 group hover:translate-x-2 md:hover:translate-x-4 transition-transform duration-500 w-full overflow-hidden">
                            <div className="w-10 h-10 md:w-20 md:h-20 rounded-full border border-[var(--color-border)] flex items-center justify-center group-hover:bg-[var(--color-tungsten)] group-hover:text-black transition-colors duration-500 shrink-0">
                                <svg className="w-4 h-4 md:w-8 md:h-8" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.831.092-.646.35-1.086.636-1.336-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.579.688.481C19.137 20.162 22 16.418 22 12c0-5.523-4.477-10-10-10z"/></svg>
                            </div>
                            <div className="flex flex-col overflow-hidden min-w-0 flex-1">
                                <span className="font-mono text-[8px] md:text-xs uppercase text-[var(--color-text-secondary)] mb-0.5 tracking-widest truncate">{t('contact.githubLabel')}</span>
                                <span className="text-sm md:text-3xl font-medium group-hover:text-[var(--color-tungsten)] transition-colors truncate block">branmarvel</span>
                            </div>
                        </a>
